...
// Helper to build pagination URLs preserving all filters
$url_params = $_GET;
...
$has_filters = $search !== "" || $filter_prog !== "" || $filter_company !== "" || $sort !== 'name_asc';
...
<div class="stat-card filter-form-card">
    <form method="GET" action="evaluate_list.php" class="filter-form filter-form-compact">
        ...
        <div class="filter-actions">
            ...
            <?php if($has_filters): ?>
                <a href="evaluate_list.php" class="clear-link">Clear All</a>
            <?php endif; ?>
        </div>
...
<div class="stat-card table-card">
    <table class="data-table">
        ...
        <tbody>
            <?php if (mysqli_num_rows($result) > 0): ?>
                ...
                <tr class="table-row">
                    ...
                    <td class="table-td">
                        ...
                        <?php else: ?>
                            <span style="color:#9ca3af; font-size:0.85rem; font-style:italic; cursor:not-allowed;">
                                Not Yet Placed
                            </span>
                        <?php endif; ?>
                    </td>
            ...
            <?php else: ?>
                <tr>
                    <td colspan="5" class="empty-state-td">No students assigned to you found.</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
